...
export const metadata: Metadata = {
  title: 'Santiya Georgieva | Frontend Engineer',
  description: 'Frontend Engineer with customer focused entrepreneurial experience',
  keywords: 'Santiya Georgieva, portfolio, javascript, developer, react, jquery, html, css, figma, adobexd',
  icons: {
    icon: '/favicon.ico',
  },
  verification: {
...
export default function Home() {
  return (
    <>
      ...
      <div className="role">
        <p className="description-creative">creative</p>
        <div className="description pageContent">
          <p>designer<span className="et-sign">&</span></p>
          <p>developer</p>
          <div className="social-icons">
            <a href="https://github.com/SantiyaGeorgieva" target="_blank" aria-label="Read more about Santiya's GitHub">
            ...
            <a href="https://www.linkedin.com/in/santiya-georgieva-919674281" target="_blank" aria-label="Read more about Santiya's LinkedIn">
              <span className="pointer">
